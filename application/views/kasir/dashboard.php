                ...
                <div class="row">
                    <ul class="nav responsive-tab nav-material nav-material-white" id="v-pills-tab">
                        <li>
                            ...
                            <i class="icon icon-home2"></i>FOOD</a>
                        </li>
                        <li>
                            <a class="nav-link" id="v-pills-2-tab" data-toggle="pill" href="#v-pills-2">
                            <i class="icon icon-plus-circle mb-3"></i>DRINK</a>
                        </li>
                    </ul>
            ...
            <div class="container-fluid relative animatedParent animateOnce">
                <div class="tab-content pb-3" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane animated fadeInUpShort show active" id="v-pills-1">
                        <div class="row">
                            <div class="col-md-4 mt-4">
                                ...
                                <div class="card" style="width: 18rem;">
                                  <br>  
                                  <img class="card-img-top center" src="<?= base_url('') ?>assets1/gambar/dadaayam.png" alt="Dada Ayam"
                                  style="width: 50%; height: 50%; margin-top: 10px;">
                        ...
                        <div class="col-md-4 mt-4">
                            <div class="card" style="width: 18rem;">
                              <img class="card-img-top center" src="<?= base_url('') ?>assets1/gambar/sayapayam.png" alt="Sayap Ayam"
                    ...
                    <div class="col-md-4 mt-4">
                        <div class="card" style="width: 18rem;">
                          <img class="card-img-top center" src="<?= base_url('') ?>assets1/gambar/pahamayam.png" alt="Paha Ayam"
                          style="width: 50%; height: 50%;">
                          <div class="card-body text-center">
                            <h5 class="card-title">Paha Ayam</h5>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-4">
                    <div class="card mt-1" style="width: 18rem;">
                        <img class="card-img-top center" src="<?= base_url('') ?>assets1/gambar/cocacola.jpg" alt="Coca Cola"
                      style="width: 50%; height: 50%;">
                        <div class="card-body text-center">
                ...
                <div class="col-md-4 mt-4">
                    <div class="card mt-1" style="width: 18rem;">
                        <img class="card-img-top center" src="<?= base_url('') ?>assets1/gambar/fanta.jpg" alt="Fanta"
                      style="width: 50%; height: 50%;">
                        <div class="card-body text-center">
                            <h5 class="card-title">Coca Cola</h5>
                            <p class="card-text">Rp. 7.000</p>
                ...
                <div class="col-md-4 mt-4">
                    <div class="card mt-1" style="width: 18rem;">
                        <img class="card-img-top center" src="<?= base_url('') ?>assets1/gambar/sprite.jpg" alt="Sprite"
                      style="width: 50%; height: 50%;">
                        <div class="card-body text-center">
                            <h5 class="card-title">Coca Cola</h5>
                            <p class="card-text">Rp. 7.000</p>
